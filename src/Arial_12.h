...
const uint8_t Arial_12Bitmaps[] PROGMEM = {
    // 0x0 [0x20 ' ']
...
const GFXglyph Arial_12Glyphs[] PROGMEM = {
    {   0,  0,  0,  8,  7, -15 }, // 0x20 ' '
    {   0,  1, 12,  6,  2, -12 }, // 0x21 '!'
    {   2,  4,  4,  7,  1, -12 }, // 0x22 '"'
    {   4,  9, 12, 10,  0, -12 }, // 0x23 '#'
...
const GFXfont Arial_12 PROGMEM = {
    (uint8_t  *)Arial_12Bitmaps,
    (GFXglyph *)Arial_12Glyphs,
    32, 255, 18
};
